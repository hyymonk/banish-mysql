 ...
 *
 */
public class PBigDecimalColumnMeta extends ColumnMeta {
	
	private final String[] extra;
	
	protected PBigDecimalColumnMeta(Field field) {
		super(field);
	...
	public String dbColumnType() {
		if(extra.length != 2) {
			...
			return "numeric(" + extra[0] + ", " + extra[1] + ")";
		}
	}
	...
	public boolean isChange(String dbColumnType, String dbColumnExtra) {
		if(!dbColumnType.startsWith("numeric")) {
			return true;
		}
